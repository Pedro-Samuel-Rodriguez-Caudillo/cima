...
### **Para IAs (Copilot, Gemini, Codex)**

**GitHub Copilot (Backend):**
```
1. Lee AGENTS_COPILOT.md completo
2. Referencia AGENTS.md para protocolos comunes
3. Sigue COMMIT_CONVENTIONS.md para commits
4. Consulta ARQUITECTURA_TECNICA.md para contexto
```

**Google Gemini (Frontend):**
```
1. Lee AGENTS_GEMINI.md completo
2. Referencia AGENTS.md para protocolos comunes
3. Sigue COMMIT_CONVENTIONS.md para commits
4. Consulta ARQUITECTURA_TECNICA.md para contexto
```
...
**OpenAI Codex (DevOps):**
```
1. Lee AGENTS_CODEX.md completo
2. Referencia AGENTS.md para protocolos comunes
3. Sigue COMMIT_CONVENTIONS.md para commits
4. Consulta ARQUITECTURA_TECNICA.md para contexto
```
