...
/// <summary>
/// Configuración de políticas de seguridad para Identity
/// </summary>
public static class IdentitySecurityConfiguration
{
    /// <summary>
    /// Configura las políticas de contraseña, lockout y seguridad
    /// </summary>
    public static IServiceCollection ConfigureCimaIdentityOptions(this IServiceCollection services)
    {
        services.Configure<IdentityOptions>(options =>
        {
            ...
            // ========================================
            // POLÍTICAS DE LOCKOUT (Bloqueo por intentos fallidos)
            // ========================================
