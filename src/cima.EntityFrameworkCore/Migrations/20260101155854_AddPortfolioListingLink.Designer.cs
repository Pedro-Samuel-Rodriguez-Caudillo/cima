...
namespace cima.Migrations
{
    ...
    [Migration("20260101155854_AddPortfolioListingLink")]
    partial class AddPortfolioListingLink
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("cima.Domain.Entities.Architect", b =>
                {
                    ...
                    b.Property<int>("TotalListingsPublished")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("cima.Domain.Entities.ContactRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("cima.Domain.Entities.FeaturedListing", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("cima.Domain.Entities.Listing", b =>
                {
                    ...
                    b.Property<Guid>("CategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValue(new Guid("c58faa45-339c-4bd5-b469-186d86fb72e0"));
                    ...
                    b.Property<Guid>("TypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValue(new Guid("9a49a6e3-4e30-4b32-a40a-f46b98eb9272"));

                    b.HasKey("Id");

                    b.HasIndex("ArchitectId")
                        .HasDatabaseName("IX_Listings_ArchitectId");
                    ...
                    b.HasIndex("TypeId")
                        .HasDatabaseName("IX_Listings_TypeId");

                    b.HasIndex("Status", "ArchitectId")
                        .HasDatabaseName("IX_Listings_Status_ArchitectId");

                    b.HasIndex("Status", "TypeId", "TransactionType")
                        .HasDatabaseName("IX_Listings_Status_Type_Transaction");

                    b.ToTable("Listings", (string)null);
                });

            modelBuilder.Entity("cima.Domain.Entities.Listings.ListingPriceHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ChangedByUserId")
                        .HasDatabaseName("IX_PriceHistory_UserId");

                    b.HasIndex("ClientIpAddress")
                        .HasDatabaseName("IX_PriceHistory_IP");
            ...
            modelBuilder.Entity("cima.Domain.Entities.Listings.ListingSale", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ListingSales", (string)null);
                });

            modelBuilder.Entity("cima.Domain.Entities.Portfolio.PortfolioProject", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("cima.Domain.Entities.PropertyCategoryEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a2469648-4ea4-40a6-a5d4-f3634a1b889f"),
                        ...
                        new
                        {
                            Id = new Guid("6988ee29-5554-4590-98af-9aa02215f5eb"),
                            CreationTime = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            Id = new Guid("3d9067c8-6dfd-43aa-b023-14f69829374c"),
                            CreationTime = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            Id = new Guid("3882f8f0-0b66-45d0-bc3a-41b8772a3067"),
                            CreationTime = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            Id = new Guid("d0dfa188-447f-4c98-89e5-117534bc18c3"),
                            CreationTime = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            Id = new Guid("c58faa45-339c-4bd5-b469-186d86fb72e0"),
                            CreationTime = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Otros",
                            IsActive = true,
                            IsDeleted = false,
            ...
            modelBuilder.Entity("cima.Domain.Entities.PropertyTypeEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CategoryId", "Name")
                        .IsUnique()
                        .HasDatabaseName("IX_Type_Category_Name");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a065c868-37a0-4589-9cdc-82cb080c545a"),
                            CategoryId = new Guid("a2469648-4ea4-40a6-a5d4-f3634a1b889f"),
                            CreationTime = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            Id = new Guid("026f298d-d208-41db-907b-a79781e0a8d5"),
                            CategoryId = new Guid("a2469648-4ea4-40a6-a5d4-f3634a1b889f"),
                            CreationTime = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            Id = new Guid("30adccd4-c21c-4b34-bda6-92c6f5381ae2"),
                            CategoryId = new Guid("a2469648-4ea4-40a6-a5d4-f3634a1b889f"),
                            CreationTime = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            Id = new Guid("49e28976-d6f4-49c0-94f2-d4ab242b08ca"),
                            CategoryId = new Guid("a2469648-4ea4-40a6-a5d4-f3634a1b889f"),
                            CreationTime = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            Id = new Guid("6dda1f32-1007-4c43-acac-580bbe2e4187"),
                            CategoryId = new Guid("a2469648-4ea4-40a6-a5d4-f3634a1b889f"),
                            CreationTime = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Villa",
                            IsActive = true,
                        ...
                        new
                        {
                            Id = new Guid("e72bca5f-f955-411b-aa28-95b744e8000a"),
                            CategoryId = new Guid("6988ee29-5554-4590-98af-9aa02215f5eb"),
                            CreationTime = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Oficina",
                            IsActive = true,
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = new Guid("70ea2410-b9c4-4bbe-92fa-6d49de1cd5ea"),
                            CategoryId = new Guid("6988ee29-5554-4590-98af-9aa02215f5eb"),
                            CreationTime = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            Id = new Guid("bff51520-df9c-4465-827a-7c1c8d12b5bb"),
                            CategoryId = new Guid("6988ee29-5554-4590-98af-9aa02215f5eb"),
                            CreationTime = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            Id = new Guid("11381d7b-6329-4c85-957c-0d51d3b1b8c5"),
                            CategoryId = new Guid("6988ee29-5554-4590-98af-9aa02215f5eb"),
                            CreationTime = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            Id = new Guid("a7f7351e-217a-49df-9059-c343f584b7f9"),
                            CategoryId = new Guid("6988ee29-5554-4590-98af-9aa02215f5eb"),
                            CreationTime = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Hotel",
                            IsActive = true,
                        ...
                        new
                        {
                            Id = new Guid("5b2a7245-7a08-4bfa-b34e-8319b3bab828"),
                            CategoryId = new Guid("d0dfa188-447f-4c98-89e5-117534bc18c3"),
                            CreationTime = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            Id = new Guid("2fc13152-ba99-4bb8-afc2-e9ac216b82cf"),
                            CategoryId = new Guid("d0dfa188-447f-4c98-89e5-117534bc18c3"),
                            CreationTime = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            Id = new Guid("13820725-10f6-47b8-9075-ff5add3e46cd"),
                            CategoryId = new Guid("3882f8f0-0b66-45d0-bc3a-41b8772a3067"),
                            CreationTime = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            Id = new Guid("16512d95-a706-4559-a203-ec8e9eedc389"),
                            CategoryId = new Guid("3882f8f0-0b66-45d0-bc3a-41b8772a3067"),
                            CreationTime = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            Id = new Guid("e4d9e3ea-9fbb-4e64-a8fa-6fbbdd6ac52f"),
                            CategoryId = new Guid("3882f8f0-0b66-45d0-bc3a-41b8772a3067"),
                            CreationTime = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            Id = new Guid("9a49a6e3-4e30-4b32-a40a-f46b98eb9272"),
                            CategoryId = new Guid("c58faa45-339c-4bd5-b469-186d86fb72e0"),
                            CreationTime = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Otro",
                            IsActive = true,
                            IsDeleted = false,
            ...
            modelBuilder.Entity("cima.Domain.Entities.TransactionTypeEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("IX_TransactionType_Code");

                    b.HasIndex("SortOrder")
                        .HasDatabaseName("IX_TransactionType_SortOrder");
            ...
            modelBuilder.Entity("cima.Domain.Entities.Listing", b =>
                {
                    ...
                    b.HasOne("cima.Domain.Entities.PropertyCategoryEntity", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("cima.Domain.Entities.PropertyTypeEntity", "PropertyType")
                        .WithMany()
                    ...
                    b.OwnsOne("cima.Domain.Entities.Listings.Address", "Location", b1 =>
                        {
                            b1.Property<Guid>("ListingId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsMany("cima.Domain.Entities.Portfolio.PortfolioImage", "Gallery", b1 =>
                        {
                            ...
                            b1.HasKey("PortfolioProjectId", "ImageId");

                            b1.ToTable("PortfolioImages", (string)null);
